...
"C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\bin\link.exe" /MANIFEST /NXCOMPAT /PDB:"C:\Users\Andrew\Source\Repos\boxdemo\Debug\ModernBox.pdb" /DYNAMICBASE "d3d11.lib" "d3dcompiler.lib" "dxgi.lib" "dxguid.lib" "kernel32.lib" "user32.lib" "gdi32.lib" "winspool.lib" "comdlg32.lib" "advapi32.lib" "shell32.lib" "ole32.lib" "oleaut32.lib" "uuid.lib" "odbc32.lib" "odbccp32.lib" *.obj /DEBUG /MACHINE:X86 /OUT:Box.exe /SUBSYSTEM:WINDOWS /MANIFESTUAC:"level='asInvoker' uiAccess='false'" /ManifestFile:"Debug\ModernBox.exe.intermediate.manifest" /ERRORREPORT:PROMPT /NOLOGO /TLBID:1 DirectXTK12.lib %linkerflags% 